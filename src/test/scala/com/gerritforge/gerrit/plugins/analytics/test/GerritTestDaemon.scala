...
import com.gerritforge.gerrit.plugins.analytics.{AnalyticsConfig, ContributorsResource}
import com.gerritforge.gerrit.plugins.analytics.common.CommitsStatisticsCache
import java.io.File
...
@TestPlugin(
  name = "analytics",
  sysModule = "com.gerritforge.gerrit.plugins.analytics.test.GerritTestDaemon$TestModule"
)
