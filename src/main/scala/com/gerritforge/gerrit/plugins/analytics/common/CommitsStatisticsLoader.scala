...
import com.gerritforge.gerrit.plugins.analytics.{AnalyticsConfig, CommitInfo, IssueInfo}
...
import com.googlesource.gerrit.plugins.analytics.common.RevisionBrowsingSupport.PimpedRevCommit
