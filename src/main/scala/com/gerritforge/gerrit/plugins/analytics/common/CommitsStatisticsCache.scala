...
class CommitsStatisticsCacheImpl @Inject() (@Named(CommitsStatisticsCache.COMMITS_STATISTICS_CACHE) commitStatsCache: LoadingCache[CommitsStatisticsCacheKey, CommitsStatistics]
